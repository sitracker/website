...
<?php
echo "<h2><div style='float:right;margin-top:6px;'><a href='{$newsfeedurl}' title='News feed (RSS)'>";
echo "<img src='feed-icon-12x12.png' width='12' height='12' alt='' /></a></div>News</h2>";
