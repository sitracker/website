...
echo translation_percent_bar('English (US), en-US', 100);
echo translation_percent_bar('Cymraeg, cy-GB', 100);
echo translation_percent_bar('Dansk, da-DK', 100);
echo translation_percent_bar('Deutsch, de-DE', 100);
echo translation_percent_bar('Español (Mexicano), es-MX', 100);
echo translation_percent_bar('Português, pt-PT', 100);
echo translation_percent_bar('Русский, ru-RU', 100);
echo translation_percent_bar('Español, es-ES', 99.94);
echo translation_percent_bar('Norsk Bokmål, nb-NO', 99.44);
echo translation_percent_bar('Français, fr-FR', 99.29);
echo translation_percent_bar('Nederlands, nl-NL', 99.27);
echo translation_percent_bar('български, bg-BG', 97.02);
echo translation_percent_bar('Polski, pl-PL', 90.88);
echo translation_percent_bar('فارسی, fa-ir', 90.06);
...
echo translation_percent_bar('Español (Colombia), es-CO', 47.64);
echo translation_percent_bar('Català, ca-ES', 38.91);
