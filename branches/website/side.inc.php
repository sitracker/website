...
echo translation_percent_bar('de-DE', 100);
echo translation_percent_bar('es-MX', 100);
echo translation_percent_bar('pt-PT', 100);
...
echo translation_percent_bar('fa-ir', 90.06);
